...
def day_5_2017_part_1(instructions):
    """Part 1."""
    steps = [int(i) for i in instructions.split('\n')]
    n = len(steps)
    current_index = 0
    steps_taken = 0

    while True:
        next_index = current_index + steps[current_index]
...
def day_5_2017_part_2(instructions):
    """Part 2."""
    steps = [int(i) for i in instructions.split('\n')]
    n = len(steps)
    current_index = 0

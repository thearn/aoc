...
def day_4_2017_part_2(seq):
    """Part 2."""
    phrases = [''.join(sorted(i)) for i in seq.split()]
    n = len(phrases)
...
@pytest.mark.parametrize('method, inp, expected', [
    (day_4_2017_part_1, 'aa bb cc dd ee', True),
    (day_4_2017_part_1, 'aa bb cc dd aa', False),
    (day_4_2017_part_1, 'aa bb cc dd aaa', True),

    (day_4_2017_part_2, 'abcde fghij', True),
    (day_4_2017_part_2, 'abcde xyz ecdab', False),
    (day_4_2017_part_2, 'a ab abc abd abf abj', True),
...
if __name__ == '__main__':
    # show solution
    valid_1 = [p for p in main_inp.split("\n") if day_4_2017_part_1(p)]
    print('day_4_2017_part_1 solution:', len(valid_1))

    valid_2 = [p for p in main_inp.split("\n") if day_4_2017_part_2(p)]
    print('day_4_2017_part_2 solution:', len(valid_2))

...
@pytest.mark.parametrize('inp, expected, method', [
    (day_4_2017_part_1, 0, 0),
    (day_4_2017_part_2, 0, 0),
])
...
if __name__ == '__main__':
    # show solution
    main_inp = 0
    print('day_4_2017_part_1 solution:', day_4_2017_part_1(main_inp))
    print('day_4_2017_part_2 solution:', day_4_2017_part_2(main_inp))

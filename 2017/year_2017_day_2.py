...
def day_2_2017_part_2(n):
    ...
    checksum = 0
    for row in rows:
        values = sorted([int(i) for i in row.split()])
        size = len(values)
...
if __name__ == '__main__':
    ...
    # show solution
    main_inp = """1236  741 557 1029    144 101 1968    2159    1399    80  1139    1167    1695    82  90  2236
...
66  87  176 107 2791    109 21  92  3016    2239    1708    3175    3210    2842    446 484"""
    print("day_2_2017_part_1 solution :", day_2_2017_part_1(main_inp))
    print("day_2_2017_part_1 solution :", day_2_2017_part_2(main_inp))

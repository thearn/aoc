...
@pytest.mark.parametrize('method, inp, expected', [
    ...
    (day_9_2017_part_1, '{{{}}}', 6),
    (day_9_2017_part_1, '{{},{}}', 5),
    (day_9_2017_part_1, '{{{},{},{{}}}}', 16),
    (day_9_2017_part_1, '{<a>,<a>,<a>,<a>}', 1),
    (day_9_2017_part_1, '{{<ab>},{<ab>},{<ab>},{<ab>}}', 9),
    (day_9_2017_part_1, '{{<!!>},{<!!>},{<!!>},{<!!>}}', 9),
    (day_9_2017_part_1, '{{<a!>},{<a!>},{<a!>},{<ab>}}', 3),
    ...
    (day_9_2017_part_2, '<!!>', 0),
    (day_9_2017_part_2, '<!!!>>', 0),
    (day_9_2017_part_2, '<{o"i!a,<{i<a>', 10),
])
def test_day_9_2017_cases(method, inp, expected):
    """Test both parts."""
